    ...
    public class AuthController : ControllerBase
    {
        ...
        */
        ...
        public async Task<IActionResult> Update([FromBody] UpdateUserRequestDTO updateUserRequest)
        {
            ...
            if (!string.IsNullOrEmpty(updateUserRequest.ProfilePictureUrl) && updateUserRequest.ProfilePictureUrl != user.ProfilePictureUrl)
            {
                user.ProfilePictureUrl = updateUserRequest.ProfilePictureUrl;
                isUserUpdated = true;
            } else
            {
                user.ProfilePictureUrl = "https://res.cloudinary.com/dpd6oloy8/image/upload/v1729058704/DefualtProfilePicture_atiafh.png";
                isUserUpdated = true;
            }
